...
<svg on:mousemove={rotate} class="h-[25px] fill-whitestar relative inset-y-[-200px]" id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48.98 61.34">
